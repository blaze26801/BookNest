...
<body>
    <div id="container">
        ...
        <main>
            <div id="books">
                <div class="book">
                    <img src="img/book-covers/tree1_d.png" alt="okładka książki">
                    <h2>Book Title</h2>
                    <p>Author</p>
                    <p>Price</p>
                    <button class="basket-remove">Usuń z koszyka</button>
                </div>
                <div class="book">
                    <img src="img/book-covers/tree1_d.png" alt="okładka książki">
                    <h2>Book Title</h2>
                ...
                <div class="book">
                 ...
                 <hr>
                <div id="checkout">
                    <button id="checkout-button">Przejdź do zakupu</button>
                </div>
            </div>
        </main>
